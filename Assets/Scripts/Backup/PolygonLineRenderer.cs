...
public class PolygonLineRenderer : MonoBehaviour
{
    ...
    public void Creation(Shape s, Color c, float size)
    {
        ...
        switch(s)
        {
            ...
            case Shape.Hexagon:
                vertices =
                    new Vector2[] { // size 1.75 hexagon
                    new Vector2(-0.875f, 0)*size,
                    new Vector2(-1.75f, 1.516f)*size,
                    new Vector2(-0.875f, 3.031f)*size,
                    new Vector2(0.875f, 3.031f)*size,
                    new Vector2(1.75f, 1.516f)*size,
                    new Vector2(0.875f, 0)*size,
                    
                    /*new Vector2[] { // size 2 hexagon
                    new Vector2(-1f, 0)*size,
                    new Vector2(-2f, 1.732f)*size,
                    new Vector2(-1, 3.464f)*size,
                    new Vector2(1f, 3.464f)*size,
                    new Vector2(2f, 1.732f)*size,
                    new Vector2(1f, 0)*size,*/
                };
                color = c;
    ...
    // Create a circle with line renderer
    public void Circle(float size)
    {
        int segments = 100;
        float xradius = size + 0.75f;
        float yradius = size + 0.75f;
        float x;
        float y;
        float z = 0f;
        ...
        _spriteRenderer.sprite = (Sprite) Resources.Load("Art/TitleShapeFills/Circle");
        _spriteRenderer.material = (Material) Resources.Load("Art/TitleShapeFills/Circle"); // FIGURE OUT THIS CIRCLE JUNK
        _lineRenderer.startColor = this.color;
        _lineRenderer.endColor = this.color;
    }
